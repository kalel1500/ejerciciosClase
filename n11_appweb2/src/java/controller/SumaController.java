    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (parametro=="1") {
                ...
                out.println("<html>");
                out.println("<head>");
                out.println("<title>Servlet SumaController</title>");            
                out.println("</head>");
                out.println("<body>");
                    out.println("<form action='SumaController' method='POST'>");
                        out.println("<input type='text' name='num1'><br>");
                        out.println("<input type='text' name='num2'><br>");
                        out.println("<input type='submit' name='enviar'><br>");
                    out.println("</form>");
                out.println("</body>");
                out.println("</html>");
            }
