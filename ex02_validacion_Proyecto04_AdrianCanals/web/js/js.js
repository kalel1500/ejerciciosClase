...
function checkFormLogin(idForm) {
    $(idForm).on("submit", function () {
        //alert('a');
        var res = true;
        if (checkInput("#admin_correo", emailPattern)) {
            ocultarError("#err_admin_correo");
        } else {
            mostrarError("#err_admin_correo", "Introduce un correo valido");
            res = false;
        }
        
        if (checkInput("#admin_password", passPattern)) {
            ocultarError("#err_admin_password");
        } else {
            mostrarError("#err_admin_password", "Minimo 4 caracteres");
            res =  false;
        }
...
$(function () {
    checkFormLogin("#admin");
});


 //administrador (lo deshabilitamos para ver la validacion de servidor)-------------------------------------------------------
function checkFormUsu(idForm) {
    $(idForm).on("submit", function () {
        //alert('a');
        var res = true;
        if (checkInput("#admin_edad", intPattern)) {
            ocultarError("#err_admin_edad");
        } else {
            mostrarError("#err_admin_edad", "Introduce un numero valido");
            res = false;
        }
