<%-- 
    Document   : nav
    Created on : 08-abr-2019, 17:48:43
    Author     : Usuario
--%>
            ...
            <ul class="nav navbar-nav navbar-right">
                <c:choose>
                    <c:when test="${sessionScope.us != null}">
                        <li <% out.println((title.equals("Perfil"))?"class=active":""); %> id="li-link-nombre-usuario"><a href=""><span class="glyphicon glyphicon-user"></span> ${us.admin_correo}</a></li>
